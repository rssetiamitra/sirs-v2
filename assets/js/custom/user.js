...
$(document).ready(function() {
  ...
  //initiate dataTables plugin
    ...
    $('#dynamic-table tbody').on( 'click', 'tr', function () {
      ...
      .addClass('dropdown-user dropdown-light dropdown-caret dropdown-caret-right')
      ...
      /********************************/
      //add tooltip for small view action buttons in dropdown user
