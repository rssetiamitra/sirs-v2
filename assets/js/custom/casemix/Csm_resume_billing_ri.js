...
$(document).ready(function() {
  //initiate dataTables plugin
    oTable = $('#dynamic-table').DataTable({ 
      ...
      "ajax": {
          "url": "casemix/Csm_resume_billing_ri/get_data",
          "type": "POST"
      },
      "columnDefs": [
        { 
    ...
    $('#dynamic-table tbody').on( 'click', 'tr', function () {
      ...
      $('#btn_search_data').click(function (e) {
          e.preventDefault();
          $.ajax({
          url: 'casemix/Csm_resume_billing_ri/find_data',
          type: "post",
      ...
      $('#btn_export_pdf').click(function (e) {
          ...
          window.open('Templates/export_data/exportContent?frmdt='+from_tgl_reg+'&todt='+to_tgl_reg+'&type=pdf&mod=Csm_resume_billing_ri','_blank');     
      });
...
function reset_table(){
    oTable.ajax.url('casemix/Csm_resume_billing_ri/get_data').load();
