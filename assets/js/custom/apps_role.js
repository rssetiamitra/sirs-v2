...
$(document).ready(function() {
  ...
  //initiate dataTables plugin
    oTable = $('#dynamic-table').DataTable({ 
      ...
      "ajax": {
          "url": "setting/apps_role/get_data",
          "type": "POST"
      },
    ...
    $('#dynamic-table tbody').on( 'click', 'tr', function () {
      ...
      .addClass('dropdown-apps_role dropdown-light dropdown-caret dropdown-caret-right')
      ...
      /********************************/
      //add tooltip for small view action buttons in dropdown apps_role
