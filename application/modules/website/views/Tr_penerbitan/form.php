...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_penerbitan/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_penerbitan?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_penerbitan/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <select name="wp_category" class="form-control">
                      ...
                      <option value="3" <?php echo isset($value) ? ($value->wp_category == 3)? 'selected' : '' : '' ;?> >News Letter</option>
                      <option value="4" <?php echo isset($value) ? ($value->wp_category == 4)? 'selected' : '' : '' ;?>>Jurnal Etika Pemilu</option>
                      <option value="5" <?php echo isset($value) ? ($value->wp_category == 5)? 'selected' : '' : '' ;?>>Klipping Berita</option>
                      <option value="6" <?php echo isset($value) ? ($value->wp_category == 6)? 'selected' : '' : '' ;?>>Buku</option>
                      <option value="7" <?php echo isset($value) ? ($value->wp_category == 7)? 'selected' : '' : '' ;?>>Makalah</option>
                    </select>
                  </div>
                </div>
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <input name="wp_author" id="wp_author" value="<?php echo isset($value)?$value->wp_author:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div> -->
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Cover File</label>
                  <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <textarea name="content" class="form-control" rows="10" style="height:100px !important"><?php echo isset($value->wp_content)?$value->wp_content:''?></textarea>
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <input type="hidden" name="wm_id" value="6">

                  <a onclick="getMenu('website/Tr_penerbitan')" href="#" class="btn btn-sm btn-success">
