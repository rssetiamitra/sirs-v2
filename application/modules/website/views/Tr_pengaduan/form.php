...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_pengaduan/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_pengaduan?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_pengaduan/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->wpg_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-2">Nomor Pengaduan</label>
                  <div class="col-md-3">
                    <input name="wpg_nomor" id="wpg_nomor" value="<?php echo isset($value)?$value->wpg_nomor:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="input-group">
                      <input class="form-control date-picker" name="wpg_tanggal" id="wpg_tanggal" type="text" data-date-format="yyyy-mm-dd" <?php echo ($flag=='read')?'readonly':''?> value="<?php echo isset($value)?$value->wpg_tanggal:date('Y-m-d')?>"/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="wpg_pengadu" class="form-field-tags" value="<?php echo isset($value)?$value->wpg_pengadu:''?>" placeholder="Ketik Nama ..." /><br>
                    <i>Klik <b>"enter"</b> untuk memasukan nama lebih dari satu orang</i>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="wpg_teradu" class="form-field-tags" value="<?php echo isset($value)?$value->wpg_teradu:''?>" placeholder="Ketik Nama ..." /><br>
                    <i>Klik <b>"enter"</b> untuk memasukan nama lebih dari satu orang</i>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <input name="wpg_hasil" id="wpg_hasil" value="<?php echo isset($value)?$value->wpg_hasil:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-2">Alat Bukti</label>
                  <div class="col-md-7">
                    <textarea class="form-control" name="wpg_alat_bukti" style="height:100px !important"><?php echo isset($value->wpg_alat_bukti)?$value->wpg_alat_bukti:''?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <div class="wysiwyg-editor" id="editor"><?php echo isset($value->wpg_pokok_perkara)?$value->wpg_pokok_perkara:''?></div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5">
                    <textarea class="form-control" name="wpg_keterangan" style="height:100px !important"><?php echo isset($value->wpg_keterangan)?$value->wpg_keterangan:''?></textarea>
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('website/Tr_pengaduan')" href="#" class="btn btn-sm btn-success">
