...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_artikel/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_artikel?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_artikel/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <input type="hidden" name="wm_id" value="1">

                  <a onclick="getMenu('website/Tr_artikel')" href="#" class="btn btn-sm btn-success">
