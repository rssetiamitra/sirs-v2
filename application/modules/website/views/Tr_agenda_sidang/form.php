...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_agenda_sidang/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_agenda_sidang?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_agenda_sidang/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->was_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Nama Agenda</label>
                  <div class="col-md-3">
                    <input name="was_nama_agenda" id="was_nama_agenda" value="<?php echo isset($value)?$value->was_nama_agenda:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Jenis Agenda</label>
                  <div class="col-md-3">
                    <select name="was_type" class="form-control">
                      <option value="">-Silahkan Pilih-</option>
                      <option value="1" <?php echo isset($value) ? ($value->was_type == 1)? 'selected' : '' : '' ;?> >Agenda Sidang</option>
                      <option value="2" <?php echo isset($value) ? ($value->was_type == 2)? 'selected' : '' : '' ;?>>Agenda Umum</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-2">Nomor Perkara</label>
                  <div class="col-md-3">
                    <input name="was_no_perkara" id="was_no_perkara" value="<?php echo isset($value)?$value->was_no_perkara:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="input-group">
                      <input class="form-control date-picker" name="was_tanggal_sidang" id="was_tanggal_sidang" type="text" data-date-format="yyyy-mm-dd" <?php echo ($flag=='read')?'readonly':''?> value="<?php echo isset($value)?$value->was_tanggal_sidang:date('Y-m-d')?>"/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="was_pengadu" class="form-field-tags" value="<?php echo isset($value)?$value->was_pengadu:''?>" placeholder="Ketik Nama ..." /><br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="was_teradu" class="form-field-tags" value="<?php echo isset($value)?$value->was_teradu:''?>" placeholder="Ketik Nama ..." /><br>
                    <i>Klik <b>"enter"</b> untuk memasukan nama lebih dari satu orang</i>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <div class="wysiwyg-editor" id="editor"><?php echo isset($value->was_pokok_perkara)?$value->was_pokok_perkara:''?></div>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('website/Tr_agenda_sidang')" href="#" class="btn btn-sm btn-success">
