...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_berita/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_berita?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_berita/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->wp_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="wp_title" id="wp_title" value="<?php echo isset($value)?$value->wp_title:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                  </div>
                </div>
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="wp_subtitle" id="wp_subtitle" value="<?php echo isset($value)?$value->wp_subtitle:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                  </div>
                </div> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
                    <select name="wp_category" class="form-control">
                      <option value="">-Silahkan Pilih-</option>
                      <option value="1" <?php echo isset($value) ? ($value->wp_category == 1)? 'selected' : '' : '' ;?> >Activities</option>
                      <option value="2" <?php echo isset($value) ? ($value->wp_category == 2)? 'selected' : '' : '' ;?>>Pers Release</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <div class="input-group">
                      <input class="form-control date-picker" name="wp_date" id="wp_date" type="text" data-date-format="yyyy-mm-dd" <?php echo ($flag=='read')?'readonly':''?> value="<?php echo isset($value)?$value->wp_date:date('Y-m-d')?>"/>
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="wp_source" id="wp_source" value="<?php echo isset($value)?$value->wp_source:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                </div> -->
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Images File</label>
                  <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" name="wp_tags" class="form-field-tags" value="<?php echo isset($value)?$value->wp_tags:''?>" placeholder="Masukan kata ..." /><br>
                    <i>Klik <b>"enter"</b> untuk memasukan tags lebih dari satu</i>
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-2">Posting Content</label>
                  <div class="col-md-10">
                    <div class="wysiwyg-editor" id="editor"><?php echo isset($value->wp_content)?$value->wp_content:''?></div>
                    <textarea spellcheck="false" id="content" name="content" style="display:none"></textarea>
                  </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-md-2">Nama File</label>
                  <div class="col-md-2">
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <input type="hidden" name="wm_id" value="2">

                  <a onclick="getMenu('website/Tr_berita')" href="#" class="btn btn-sm btn-success">
