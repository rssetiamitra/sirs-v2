...

{
  ...
  if(b != 0){
    $.getJSON("<?php echo base_url('website/Tr_video/delete_file') ?>/" + b, '', function(data) {
    ...
    /*$('#form_posting').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('website/Tr_video?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_posting" action="<?php echo site_url('website/Tr_video/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Tanggal Video</label>
                  <div class="col-md-2">
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Cover Video</label>
                  <div class="col-md-4">
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('website/Tr_video')" href="#" class="btn btn-sm btn-success">
