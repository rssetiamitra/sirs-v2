    ...
    $('#form_example').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('example?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_example" action="<?php echo site_url('example/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->example_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <input name="type" id="type" value="<?php echo isset($value)?$value->type:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>

                  <label class="control-label col-md-1">File</label>
                  <div class="col-md-3">
                    <input name="file" id="file" value="<?php echo isset($value)?$value->file:''?>" placeholder="" class="form-control" type="file" <?php echo ($flag=='read')?'readonly':''?>>
                  </div>
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Select your</label>
                  <div class="col-md-4">
                    <?php echo $this->master->custom_selection(array('table'=>'role', 'where'=>array('is_active'=>'Y'), 'id'=>'role_id', 'name' => 'role_name'),isset($value)?$value->select:'','select','select','chosen-slect form-control',($flag=='read')?'readonly':'','');?>
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <!-- <input type="text" name="id" value="<?php echo isset($value)?$value->example_id:0?>"> -->

                  <a onclick="getMenu('example')" href="#" class="btn btn-sm btn-success">
