    ...
    $('#form_Tmp_mst_function').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('registrasi/Reg_pasien?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_Tmp_mst_function" action="<?php echo site_url('registrasi/Reg_pasien/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('registrasi/Reg_pasien')" href="#" class="btn btn-sm btn-success">
