    ...
    $('#form_Hdesk_contact').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('help_desk/Hdesk_contact?flag='+flag);
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
              ...
              <form class="form-horizontal" method="post" id="form_Hdesk_contact" action="<?php echo site_url('help_desk/Hdesk_contact/process')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select name="flag" class="form-control" id="flag">
                    ...
                    <option value="dr" <?php echo isset($value) ? ($value->flag=='dr')?'selected':'' : '' ?> >Kontak Dokter</option>
                    <option value="comp" <?php echo isset($value) ? ($value->flag=='comp')?'selected':'' : '' ?> >Kontak Perusahaan</option>
                    <option value="etc" <?php echo isset($value) ? ($value->flag=='etc')?'selected':'' : '' ?>>Lainnya</option>
                  </select>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('help_desk/Hdesk_contact?flag=<?php echo $_GET['flag']?>')" href="#" class="btn btn-sm btn-success">
