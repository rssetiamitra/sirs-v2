            ...
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_Csm_billing_pasien" action="<?php echo site_url('casemix/Csm_billing_pasien/process')?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-2">
                    <input name="no_sep" id="no_sep" value="<?php echo $reg->csm_rp_no_sep?>" class="form-control" type="text">
                  </div>
                  ...
                  <div class="col-md-10">
                    <div class="col-md-7">
                     ...
                     <tr>
                         ...
                         <td width="100px" align="right"><input type="text" name="nama_tindakan[]" id="subtotal_tindakan" class="form-control" style="width:100%;text-align:right; font-size:16px;font-weight:bold" value="<?php echo array_sum($sum_subtotal)?>"></td>
                     </tr>   
                     </table>
                     <br>
                     </div>
                     ...
                     <tr>
                         <th>Dokter</th>
                         <td align="right"><input type="text" name="" id="bill_dr" value="<?php echo $resume->csm_brp_bill_dr?>" class="form-control" style="width:150px;text-align:right" style="text-align:right" readonly></td>
                     </tr>
                     <tr>
                         <th>Administrasi</th>
                         <td align="right"><input type="text" name="" id="bill_adm" value="<?php echo $resume->csm_brp_bill_adm?>" class="form-control" style="width:150px;text-align:right" style="text-align:right" readonly></td>
                     </tr>
                     <tr>
                         <th>Obat/Farmasi</th>
                         <td align="right"><input type="text" name="" id="bill_far" value="<?php echo $resume->csm_brp_bill_far?>" class="form-control" style="width:150px;text-align:right" style="text-align:right" readonly></td>
                     </tr>
                     <tr>
                         <th>Penunjang Medis</th>
                         <td align="right"><input type="text" name="" id="bill_pm" value="<?php echo $resume->csm_brp_bill_pm?>" class="form-control" style="width:150px;text-align:right" style="text-align:right" readonly></td>
                     </tr>
                     <tr>
                         <th>Tindakan</th>
                         <td align="right"><input type="text" name="" id="bill_tindakan" value="<?php echo $resume->csm_brp_bill_tindakan?>" class="form-control" style="width:150px;text-align:right" style="text-align:right" readonly></td>
                     </tr>
                     ...
                     <tr>
                         ...
                         <td align="right"><input type="text" name="" value="<?php echo $total_billing?>" class="form-control" style="font-size:16px;font-weight:bold;width:150px;text-align:right" readonly></td>
                     </tr>
                     </table> 
                     </div> 
                  </div>
