...
class Tmp_role_has_menu extends MX_Controller {
    ...
    public function form($id='')
    {
        ...
        if( $id != '' ){
            ...
            $this->breadcrumbs->push('Edit role privileges', 'Tmp_role_has_menu/'.strtolower(get_class($this)).'/'.__FUNCTION__.'/'.$id);
            /*get value by id*/
            ...
            $this->breadcrumbs->push('Add role privileges', 'Tmp_role_has_menu/'.strtolower(get_class($this)).'/form');
    ...
    public function show($id)
    {
        ...
        $this->breadcrumbs->push('View role privileges', 'Tmp_role_has_menu/'.strtolower(get_class($this)).'/'.__FUNCTION__.'/'.$id);
    ...
    public function delete()
    {
        ...
        if($id!=null){
            if($this->Tmp_role_has_menu->delete_by_id($toArray)){
                $this->logs->save('tmp_role_has_menu', $id, 'delete record', '');
