...
class Tmp_user_has_role_model extends CI_Model {
	...
	var $table = 'tmp_user';
	var $column = array('tmp_user.fullname','tmp_user.email','tmp_user.username','tmp_user.role_name','tmp_user.is_active','tmp_user.updated_date','tmp_user.created_date', 'tmp_user.name');
	var $select = 'tmp_user.*';
