...
class Tmp_mst_modul_model extends CI_Model {
	...
	var $column = array('tmp_mst_modul.name','tmp_mst_modul.description','tmp_mst_modul.is_active','tmp_mst_modul.updated_date','tmp_mst_modul.created_date', 'tmp_mst_modul.name');
	var $select = 'tmp_mst_modul.*';
