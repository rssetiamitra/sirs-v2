    ...
    $('#form_provinces').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('reference/regional/provinces?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_provinces" action="<?php echo site_url('reference/regional/provinces/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('reference/regional/provinces')" href="#" class="btn btn-sm btn-success">
