    ...
    $('#form_regencies').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('reference/regional/regencies?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_regencies" action="<?php echo site_url('reference/regional/regencies/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-group">
                  <label class="control-label col-md-2">Regencies Name</label>
                  <div class="col-md-4">
                ...
                <div class="form-actions center">
                  ...
                  <a onclick="getMenu('reference/regional/regencies')" href="#" class="btn btn-sm btn-success">
