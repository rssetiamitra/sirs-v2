    ...
    $('#form_jenis_surat').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('master_data/mst_jenis_surat?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_jenis_surat" action="<?php echo site_url('master_data/mst_jenis_surat/process')?>" enctype="multipart/form-data">
                <br>

                <div class="form-group">
                  <label class="control-label col-md-2">ID</label>
                  <div class="col-md-1">
                    <input name="id" id="id" value="<?php echo isset($value)?$value->js_id:0?>" placeholder="Auto" class="form-control" type="text" readonly>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input name="js_nama" id="js_nama" value="<?php echo isset($value)?$value->js_nama:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <!-- <input type="text" name="id" value="<?php echo isset($value)?$value->js_id:0?>"> -->

                  <a onclick="getMenu('master_data/mst_jenis_surat')" href="#" class="btn btn-sm btn-success">
