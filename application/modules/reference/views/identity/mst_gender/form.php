    ...
    $('#form_role').ajaxForm({
      ...
      complete: function(xhr) {     
        ...
        if(jsonResponse.status === 200){
          ...
          $('#page-area-content').load('reference/identity/mst_gender?_=' + (new Date()).getTime());
        }else{
          $.achtung({message: jsonResponse.message, timeout:5});
        }
        achtungHideLoader();
    ...
    <!-- PAGE CONTENT BEGINS -->
          <div class="widget-body">
            <div class="widget-main no-padding">
              <form class="form-horizontal" method="post" id="form_role" action="<?php echo site_url('reference/identity/mst_gender/process')?>" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input name="gender_name" id="gender_name" value="<?php echo isset($value)?$value->gender_name:''?>" placeholder="" class="form-control" type="text" <?php echo ($flag=='read')?'readonly':''?> >
                  </div>
                </div>
                ...
                <div class="form-actions center">
                  ...
                  <!--hidden field-->
                  <!-- <input type="text" name="id" value="<?php echo isset($value)?$value->gender_id:0?>"> -->

                  <a onclick="getMenu('reference/identity/mst_gender')" href="#" class="btn btn-sm btn-success">
